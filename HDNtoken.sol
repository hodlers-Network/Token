...
contract ABCToken is StandardToken { // CHANGE THIS. Update the contract name.
...
function ABCToken () public {
    ...
    name = "Hodlers Network ";                                   // Set the name for display purposes (CHANGE THIS)
    decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
    symbol = "HDN";                                             // Set the symbol for display purposes (CHANGE THIS)
